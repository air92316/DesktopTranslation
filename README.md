...
| 📌 | **視窗置頂** | 圖釘按鈕控制常駐最上層 |
| 🔄 | **應用程式內更新** | 自動偵測新版本，一鍵下載安裝，免重新下載安裝檔 |
...
| **自動更新** | GitHub Releases API | 版本偵測 + 下載驗證 + 靜默安裝（3 次重試） |
| **打包** | Inno Setup 6 | 安裝精靈 + 自動下載 .NET Runtime |
| **網站** | Cloudflare Pages | 靜態網站託管（下載連結指向 GitHub） |
